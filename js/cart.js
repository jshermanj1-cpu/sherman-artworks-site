...
var _LOCK_SVG_SM = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="4" y="10.5" width="16" height="10" rx="2"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg>';
...
function _injectCartDrawer() {
  ...
  drawer.innerHTML =
    ...
    '<div id="cart-drawer-footer" class="cart-drawer-footer" style="display:none">' +
      ...
      '</div>' +
      // Paying by card needs a delivery address, which only the checkout page
      // asks for, so this leads there rather than trying to start a payment
      // from the drawer. It is the primary action when card payment is on:
